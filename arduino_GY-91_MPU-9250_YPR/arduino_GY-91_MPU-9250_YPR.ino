/* 
 *  Example of using the MPU-9250 as part of the GY-91 module
 *  and getting the Yaw, Pitch, Roll
 *  
 *  Note: 
 *   * requires the 2 files in this same folder: quarternionFilters and absoluteMagnetoCalib
 *   * a magnetometer calibration is performed at the beginning
 * 
 *  Based on: https://github.com/shubhampaul/Real_Time_Planet_Tracking_System/tree/master/MPU_fux_BNO_mBias
 *  Which is based on Kris Winer's MPU9250 code
 *  
